...
export async function showProviderSetup(container,ctx,documentId=null,options={}){
  ...
  $('#studio-rule-form').onsubmit=e=>{
    e.preventDefault();if(!selected){$('#rule-error').innerHTML=notice('Choose a source candidate first.','warning');$('[name=candidate-filter]').focus();return;}
