...
CODES = {'IMPORT_CSV', 'IMPORT_XML', 'IMPORT_PDF', 'CREATE_DRAFT', 'SAVE_DRAFT',
         ...
         'CONFIGURE_BILLING_SCHEDULE', 'IMPORT_USAGE_CSV', 'IMPORT_USAGE_XLSX', 'PREVIEW_USAGE', 'APPROVE_USAGE', 'REJECT_USAGE', 'WITHDRAW_USAGE',
         'ACQUISITION_ENABLE', 'ACQUISITION_DISABLE', 'ACQUISITION_PAUSE', 'ACQUISITION_RESUME',
